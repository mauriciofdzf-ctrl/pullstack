export function LogoIcon({ size = 32, className = '' }: { size?: number; className?: string }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <rect x="2" y="8" width="20" height="26" rx="3.5" fill={`url(#${id}b)`} opacity="0.38" transform="rotate(-11 12 21)" />
      <rect x="5" y="6" width="20" height="26" rx="3.5" fill={`url(#${id}b)`} opacity="0.62" transform="rotate(-4 15 19)" />
