...
export default function CartDrawer({ items, onClose, onRemove, onClear }: Props) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-[#12161f] border-l border-white/10 z-50 flex flex-col shadow-2xl">
        ...
        {step === 'cart' && (
          <>
            <div className="flex-1 overflow-y-auto">
              {items.length === 0 ? (
                ...
                <div className="p-4 space-y-3">
                  {items.map((item, i) => (
                    <div key={`${item.id}-${i}`} className="flex items-center gap-3 bg-[#191d28] border border-white/5 rounded-xl p-3">
            ...
            {items.length > 0 && (
              <div className="border-t border-white/5 p-5 space-y-4 shrink-0 bg-[#0d1018]">
        ...
        {step === 'form' && (
          <form onSubmit={handleOrder} className="flex flex-col flex-1 overflow-hidden">
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <div>
                ...
                <input value={contactName} onChange={(e) => setContactName(e.target.value)} required
                  ...
                  className="w-full bg-[#191d28] border border-white/10 text-white placeholder-gray-600 px-4 py-3 rounded-xl text-sm focus:outline-none focus:border-violet-500/50" />
              </div>
              ...
              <div>
                ...
                <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2}
                  ...
                  className="w-full bg-[#191d28] border border-white/10 text-white placeholder-gray-600 px-4 py-3 rounded-xl text-sm focus:outline-none focus:border-violet-500/50 resize-none" />
              </div>

              <div className="bg-[#191d28] border border-white/5 rounded-xl p-4 space-y-2 text-xs text-gray-500">
            ...
            <div className="border-t border-white/5 p-5 shrink-0 bg-[#0d1018]">
