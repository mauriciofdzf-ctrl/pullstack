      ...
      <div className="w-full max-w-md bg-[#1c1835] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        {step === 'method' && (
          <div className="p-5 space-y-4">
            {/* Price breakdown */}
            <div className="bg-[#26213d] border border-white/5 rounded-xl p-4 space-y-2 text-sm">
                  ...
                  <button key={m.id} onClick={() => setMethod(m.id)}
                    className={`w-full flex items-center gap-3 p-3.5 rounded-xl border transition-all text-left ${
                      method === m.id
                        ...
                        : 'border-white/5 bg-[#26213d] hover:border-white/15'
                    }`}>
        ...
        {step === 'payment' && selectedMethod && (
          <div className="p-5 space-y-4">
            ...
            <div className="flex items-center gap-3 bg-[#26213d] border border-white/5 rounded-xl p-3">
            ...
            {method && isMethodReady(method) ? (
              <div className="bg-[#26213d] border border-white/5 rounded-xl p-4 space-y-2.5">
