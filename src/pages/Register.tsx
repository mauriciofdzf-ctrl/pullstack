...
export default function Register() {
  ...
  if (success) return (
    <div className="min-h-screen bg-[#090c14] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <div className="bg-[#12161f] border border-white/5 rounded-xl p-4 text-left mb-6 space-y-2">
  ...
  return (
    <div className="min-h-screen bg-[#090c14] flex items-center justify-center px-4 py-12">
