...
export default function Register() {
  ...
  if (success) return (
    <div className="min-h-screen bg-[#06060f] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <div className="bg-[#0e0e1e] border border-white/5 rounded-xl p-4 text-left mb-6 space-y-2">
  ...
  return (
    <div className="min-h-screen bg-[#06060f] flex items-center justify-center px-4 py-12">
