...
export default function Register() {
  ...
  if (success) return (
    <div className="min-h-screen bg-[#0c0a1e] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <div className="bg-[#1c1835] border border-white/5 rounded-xl p-4 text-left mb-6 space-y-2">
  ...
  return (
    <div className="min-h-screen bg-[#0c0a1e] flex items-center justify-center px-4 py-12">
