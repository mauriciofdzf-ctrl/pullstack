...
export default function Shop() {
  ...
  return (
    <div className="min-h-screen bg-[#0c0a1e] pt-20 pb-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-10">
          ...
          <div className="relative shrink-0">
            <button className="bg-[#1c1835] border border-white/10 text-white p-3 rounded-xl hover:border-violet-500/30 transition-colors">
        ...
        <div className="flex gap-2 mb-8 flex-wrap">
          {CATS.map((c) => (
            <button key={c} onClick={() => setCat(c)}
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${cat === c ? 'bg-violet-600 text-white' : 'bg-[#1c1835] border border-white/10 text-gray-400 hover:border-violet-500/30 hover:text-violet-400'}`}>
              {c}
            </button>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {filtered.map((p, i) => (
            <div key={i}
              className="group bg-[#1c1835] border border-white/5 hover:border-violet-500/30 rounded-2xl overflow-hidden transition-all hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(139,92,246,0.15)]">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={i} className="bg-[#1c1835] border border-white/5 rounded-xl p-4 flex items-center gap-3">
