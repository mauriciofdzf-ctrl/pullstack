        ...
        {avatarEdit && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center px-4">
            <div className="bg-[#1a1a36] border border-white/10 rounded-2xl p-6 w-full max-w-sm shadow-2xl">
              ...
              {/* Tabs */}
              <div className="flex gap-1 bg-[#21213e] rounded-xl p-1 mb-4">
              ...
              {avatarTab === 'upload' ? (
                ...
                <div className="mb-4">
                  <input type="url" value={avatarUrl}
                    ...
                    className="w-full bg-[#21213e] border border-white/10 text-white placeholder-gray-600 px-4 py-3 rounded-xl text-sm focus:outline-none focus:border-violet-500/50 font-mono mb-2" />
