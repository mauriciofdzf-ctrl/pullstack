...
function RaffleCard({ raffle, onEnter, entered, loading }: {
  ...
  return (
    <div className="bg-[#1c1835] border border-white/5 hover:border-violet-500/20 rounded-2xl overflow-hidden transition-all group">
      ...
      <div className="p-4">
        ...
        <div className="mb-4">
          ...
          <div className="w-full bg-[#26213d] rounded-full h-1.5">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-[#1c1835] border border-white/5 rounded-2xl p-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a href="/messages"
              className="bg-[#26213d] border border-white/10 hover:border-violet-500/30 text-gray-300 hover:text-violet-400 font-bold px-5 py-2.5 rounded-xl text-sm transition-all whitespace-nowrap">
