        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              {SCHEDULE.map(ev => (
                <div key={ev.id} className="bg-[#1a1a1a] border border-white/5 hover:border-white/10 rounded-2xl p-4 transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    {ev.status === 'live' ? (
                      ...
                      <button onClick={() => toggle(ev.id)}
                        className={`px-3 py-1.5 rounded-lg text-xs font-bold shrink-0 border transition-all ${notifiedIds.has(ev.id) ? 'bg-violet-500/20 border-violet-500/40 text-violet-400' : 'bg-[#1d1d1d] border-white/10 text-gray-400 hover:border-white/20'}`}>
            ...
            <div className="mt-4 bg-[#1a1a1a] border border-white/5 rounded-2xl p-4 text-center">
          ...
          <div>
            ...
            <div className="space-y-3">
              {PAST.map(p => (
                <div key={p.id} className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-4">
